/* =================================================================
   ⚠ LEGACY — CELL-DEVELOPMENT STAGE 5a (preserved Session 12 for the A/B
   audition ONLY). This is the verbatim Session-9/10/11 motif-development
   stage: it develops 2–3 micro-cells across a section's bars (sequence /
   invert / fragment / ornament). The phrase-motif rework (Session 12)
   reshaped stage-5a-phrase.js into an ARRANGEMENT stage; this file is the old
   cell-development behaviour, reached only when
   config.knobs.motif_architecture === 'cell' (the inspector's
   "cell+development" audition button). PAIRED with stage-4-cells-LEGACY.js.

   TEMPORARY DEBT — scheduled for removal after Steven's listening verdict
   (kept if reverted, deleted if the pivot proves out). Do not build new work
   here. See the Session-12 journal entry.
   =================================================================
