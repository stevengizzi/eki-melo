/* =================================================================
   ⚠ LEGACY — CELL+DEVELOPMENT STAGE 4 (preserved Session 12 for the A/B
   audition ONLY). This is the verbatim Session-10 cell motif stage. It is
   NOT in the default pipeline: the phrase-motif rework (Session 12) replaced
   stage-4-motifs.js with a per-section PHRASE generator. The runner reaches
   this file only when config.knobs.motif_architecture === 'cell', which the
   inspector's "cell+development" audition button sets so Steven can A/B the
   two architectures on the same case. PAIRED with
   stage-5a-development-LEGACY.js (the cell path needs both).

   TEMPORARY DEBT — scheduled for removal after Steven's listening verdict:
   kept if the pivot is reverted (cells become the default again), DELETED if
   the pivot proves out. Do not build new work on this file. See the Session-12
   journal entry.
   =================================================================
